...
contract ERCToken is ERC20, Ownable, ERC20Burnable {
    uint256 public constant TOTAL_SUPPLY = 1000000 * (10 ** 18);

    constructor() ERC20("Token", "C20") {
...
contract MyToken is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    constructor() ERC721("MyToken", "MYN") {
        authorize[owner()] = true;
    }

    function safeMint(address to, string memory uri) public {
        // require(authorize[msg.sender], "Caller is not authorized");
    ...
    function getTokenid() external view returns (uint256 id) {
